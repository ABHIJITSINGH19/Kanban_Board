    ...
    <>
      ...
      >
          ...
          >
            {!isCollapsed && (
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-black flex items-center justify-center shadow-black shadow-lg">
        ...
        <div className="p-3 sm:p-4 border-t border-slate-100">
          ...
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white flex items-center justify-center border-2 border-black shadow-sm shrink-0">
              ...
              <>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1">
                    ...
                    <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-white flex items-center justify-center shrink-0">
                      <Check
                        size={6}
