...
const Registration = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center py-4 sm:py-8 md:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white rounded-lg border border-gray-100 shadow-2xl p-4 sm:p-6 md:p-8">
        ...
        >
          ...
          <button
            ...
            className={`w-full bg-black text-white font-medium py-2.5 sm:py-3 px-4 rounded-lg flex items-center justify-center gap-2 shadow-md text-sm sm:text-base cursor-pointer ${
